...
tmux send-keys "INSTRUMENT=nicos_ess.ymir bin/nicos-cache" C-m
...
tmux send-keys "export EPICS_PVA_AUTO_ADDR_LIST=NO" C-m
tmux send-keys "export EPICS_PVA_ADDR_LIST='172.30.238.79'" C-m
tmux send-keys "INSTRUMENT=nicos_ess.ymir bin/nicos-poller" C-m
...
tmux send-keys "export EPICS_PVA_AUTO_ADDR_LIST=NO" C-m
tmux send-keys "export EPICS_PVA_ADDR_LIST='172.30.238.79'" C-m
tmux send-keys "INSTRUMENT=nicos_ess.ymir bin/nicos-daemon" C-m
